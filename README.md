This simulation produces graphs similar to the left column of fig 3, fig 6, and fig 10 B, C in
...
I've provided the *.hoc and geometry file of each model retinal ganglion cells used in Sheasby, B.W. and Fohlmeister, J.F. 1999, where each sub-directory represents 1 neuron. They are divided into the directories based on their morphological categories determined by Toris and Miller, 1995 (Large, Medium Complex, Small Simple, etc.). I have compressed them into 1 Winzip file (sheasbyfohlmeister1999.zip). When uncompressing the files, please use the option that preserves the directory structures. ...
